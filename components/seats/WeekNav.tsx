...
export function WeekNav({ currentWeekMonday, onPrev, onNext, disablePrev }: WeekNavProps) {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
      ...
      <div className="flex items-center gap-3 bg-muted px-2 py-1 rounded-full">
        <Button variant="ghost" size="icon" onClick={onPrev} className="rounded-full" disabled={disablePrev}>
